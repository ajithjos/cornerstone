...
deploy_dev_load_config() {
	...
	export CORNERSTONE_DEV_USERNAME_SIGNIN_ENABLED="$(deploy_trim "$(setup_env_get CORNERSTONE_DEV_USERNAME_SIGNIN_ENABLED)")"
	...
	export CORNERSTONE_DEV_USERNAME_SIGNIN_ENABLED

...
pub const PROGRAMS: &[RuntimeProgramRegistration] = &[
    RuntimeProgramRegistration {
        ...
        validate: readiness_within_5::validate,
    ...
    RuntimeProgramRegistration {
        ...
        validate: anchor_facts_to_20::validate,
    ...
    RuntimeProgramRegistration {
        ...
        validate: bridge_through_10_addition::validate,
    ...
    RuntimeProgramRegistration {
        ...
        validate: bridge_through_10_subtraction::validate,
    ...
    RuntimeProgramRegistration {
        ...
        validate: multiplication_tables_to_10::validate,
    ...
    RuntimeProgramRegistration {
        ...
        validate: division_facts_from_tables::validate,
    ...
    RuntimeProgramRegistration {
        ...
        validate: mixed_add_sub_to_10::validate,
    ...
    RuntimeProgramRegistration {
        ...
        validate: mixed_add_sub_to_20::validate,
